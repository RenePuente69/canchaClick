        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="single-exclusive-four">
                    <img src="<?php echo RUTA_PRINCIPAL . 'assets/principal/'; ?>img/exclusive/7.jpg" alt="Image">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single-exclusive-four">
                    <img src="<?php echo RUTA_PRINCIPAL . 'assets/principal/'; ?>img/exclusive/8.jpg" alt="Image">
                    <div class="exclusive-content">
            ...
            <div class="col-lg-4 col-sm-6 offset-sm-3 offset-lg-0">
                <div class="single-exclusive-four">
                    <img src="<?php echo RUTA_PRINCIPAL . 'assets/principal/'; ?>img/exclusive/9.jpg" alt="Image">
                    <div class="exclusive-content">
