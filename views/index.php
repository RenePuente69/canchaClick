...
<section class="eorik-slider-area">
    <div class="eorik-slider owl-carousel owl-theme">
        <?php foreach ($data['sliders'] as $slider) { ?>
            <div class="eorik-slider-item" style="background-image: url(<?php echo RUTA_PRINCIPAL . 'assets/img/sliders/' .
                                                                            $slider['foto'] ?>);">
                <div class="d-table">
                            ...
                            <div class="form-group">
                                ...
                                <select name="canchas" class="select-auto" id="canchas" style="width: 100%;">
                                    ...
                                    <?php foreach ($data['canchas'] as $canchas) { ?>
                                        <option value="<?php echo $canchas['id'] ?>"><?php echo $canchas['estilo'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
